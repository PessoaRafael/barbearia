...
/**
 * Onde fica, num cartão com o mapa.
 *
 * O endereço já estava no rodapé em texto, e texto de endereço ninguém lê: a
 * pessoa quer ver se é perto. O mapa responde isso antes de qualquer palavra.
 *
 * O mapa é um embed do Google sem chave de API. Se um dia parar de carregar, o
 * quadro fica vazio mas o endereço, o "ver no mapa" e o telefone continuam
 * logo abaixo — ninguém deixa de achar a barbearia por causa disso.
 *
 * Horário e redes moram fora daqui de propósito. Juntos, davam um cartão de
 * 600px de altura ao lado de colunas de 150, e o rodapé ficava com um buraco
 * do tamanho de meia tela no desktop.
 */
export function OndeFica() {
  return (
    <div className="flex w-full flex-col overflow-hidden rounded-grande border border-borda bg-superficie">
      <div className="h-[180px] w-full bg-superficie-ativa">
        <iframe
...
/** Expediente, para a coluna do meio do rodapé. */
    ...
    <div className="flex flex-col gap-3">
      ...
      <ul className="flex flex-col gap-2 text-sm">
        {CASA.expediente.map((linha) => (
          <li key={linha.dia} className="flex flex-col">
...
/** Instagram e WhatsApp, embaixo do nome da casa. */
